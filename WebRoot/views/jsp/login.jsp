...
<body style="background-color: #EEEEEE" onload="judge()">
	...
	<div class="loginContain">
		...
		<div class="login">
			<form id="form1" role="form" action="login.do" method="post">
				...
				<input type="password" required class="form-control"
					name="shopperPassword" style="height: 50px; margin-top: 30px;"
					placeholder="请输入密码">
				...
				<div style="height: 100px; width: 100%; margin-top: 20px;">
					...
					<div style="float: left; width: 50%; padding: 20px;margin-top: 10px">
				...
				<div style="float: right">
					<a href="<%=request.getContextPath()%>/views/jsp/seller_login.jsp">商户登录</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="<%=request.getContextPath()%>/views/jsp/register.jsp">立即注册</a>
				</div>
			</form>
		</div>
	</div>
