...
<body>
	...
	<div>
		<div style="margin-left: 150px;">
			...
			<span style="font-size: 20px;">已完成订单</span>
		</div>
	</div>
	<div class="container"
				...
				<div style="background-color: #EEEEEE; margin-top: 20px">
					...
					<div style="float: left; margin-left: 30px;">
						...
						<br /> <span style="font-size: 18px">下单时间：<fmt:formatDate
								value='${map.value[0].orderTime }' type="both" /></span><br /><br /> <span
							style="font-size: 18px">收货时间：<fmt:formatDate
								value='${map.value[0].goodsReceivedTime }' type="both" /></span>
					</div>
					<div class="media" style="height: 5px; background-color: #EEEEEE"></div>
