...
<body>
		...
		<div class="container">
			<div class="col-md-9">
				...
				<div class="tab-pane active" id="home" style="margin-top: 30px;">
					...
					<span style="font-size: 18px; color: black;">${order[0].goods.shopName}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
	...
	<div style="margin-left: 1100px">
		<form action="showCommentGoodsList.do">
			<input type="hidden" value="${order[0].orderNumber}"
				name="orderNumber" /> <input type="submit" class="btn btn-primary"
				value="&nbsp;评价商品&nbsp&nbsp>&nbsp;"
