...
<c:if test="${sessionScope.seller!=null}">
  ...
  <div class="modify">
    <form  action="seller_modifyPwd.do" method="post">
        ...
        <input id="sellerNewPassword" required type="password" class="form-control" name="sellerNewPassword" style="height: 55px; margin-top: 30px;"
                   placeholder="请输入新的密码">
          <input id="sellerConfirmPassword" required type="password" class="form-control" name="sellerConfirmPassword" style="height: 55px; margin-top: 30px;"
                  placeholder="确认密码">  
