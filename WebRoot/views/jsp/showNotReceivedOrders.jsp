...
<body>
	...
	<div>
		<div style="margin-left: 150px;">
			...
			<span style="font-size: 20px;">待收货订单</span>
		</div>
	</div>
	<div class="container"
		...
		<div class="col-md-9">
			...
			<c:forEach items="${resultMap}" var="map">
				...
				<div style="background-color: #EEEEEE; margin-top: 20px">
					...
					<a href="comfirmReceipt.do?orderNumber=${map.value[0].orderNumber}"
						onclick="return confirm('是否确定收货？')"
						style="font-size: 18px; margin-left: 20px;">确定收货</a>
